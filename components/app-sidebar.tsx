              ...
              <li key={href}>
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ? 'border-l-sidebar-primary bg-sidebar-primary/15 text-sidebar-primary font-medium'
                      : 'border-l-transparent text-sidebar-foreground/60 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground'
                  )}
                >
